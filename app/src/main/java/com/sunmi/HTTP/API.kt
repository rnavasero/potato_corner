 ...
 */
object API {
    private const val BASE_URL      = "http://192.168.0.78:8000"
    const val LOGIN                 = "$BASE_URL/auth/login"
    const val LOGOUT                = "$BASE_URL/auth/logout"
    const val REGISTER              = "$BASE_URL/user"

    const val PRODUCTS              = "$BASE_URL/products/mobile"
    ...
    const val CATEGORY              = "$BASE_URL/products/mobile/namesbycategory/"
}